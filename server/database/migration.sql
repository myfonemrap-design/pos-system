-- =====================================================
-- Repair Shop POS - Migration Script
...
-- =====================================================
-- Add missing columns safely (migration)
-- =====================================================
SET @dbname = DATABASE();

-- Add cost_price to invoice_items if missing
SET @preparedStatement = (SELECT IF(
    (SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = @dbname AND TABLE_NAME = 'invoice_items' AND COLUMN_NAME = 'cost_price') = 0,
    'ALTER TABLE invoice_items ADD COLUMN cost_price DECIMAL(10,2) NOT NULL DEFAULT 0.00 AFTER unit_price',
    'SELECT 1'
));
PREPARE migrateIfNeeded FROM @preparedStatement;
EXECUTE migrateIfNeeded;
DEALLOCATE PREPARE migrateIfNeeded;

-- =====================================================
-- Seed data (INSERT IGNORE - won't overwrite)
-- =====================================================
